<script lang="ts">
	...
	const tabs = [
		{ href: '/products/tree',           label: 'Product Tree' },
		{ href: '/products/classification', label: 'Data Classification' },
	];
...
<div class="products">
	<div class="page-head">
		<h1>Products</h1>
		<p class="sub">Product hierarchy and data classification.</p>
	</div>

	<nav class="tabs" aria-label="Products sections">
